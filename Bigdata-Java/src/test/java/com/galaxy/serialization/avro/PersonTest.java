package com.galaxy.serialization.avro;
...
public class PersonTest {
    ...
    public void serilized_compile() throws IOException {
        ...
        dfw.create(alice.getSchema(), new File("./src/test/java/com/galaxy/serialization/avro/person.avrc"));
        dfw.append(alice);
        dfw.close();
    }
    ...
    public void reserilized() throws IOException {
        ...
        DataFileReader<Person> dtr = new DataFileReader<Person>(new File("./src/test/java/com/galaxy/serialization/avro/person.avrc"), dt);
        DataFileReader<Person> dtr1 = new DataFileReader<Person>(new File("./src/test/java/com/galaxy/serialization/avro/newp.avrc"), dt);
        while (dtr.hasNext()) {
    ...
    public void serilized_without_compile() throws IOException {
        ...
        Schema schema = new Schema.Parser().parse(new File("./src/main/java/com/galaxy/serialization/avro/person.avro"));
        ...
        dfw.create(schema, new File("./src/test/java/com/galaxy/serialization/avro/newp.avrc"));
        dfw.append(record);
        dfw.close();
