...
public class FsysClassLoaderT {
	public static void main(String[] args) throws Exception{
		...
		Class<?> c = loader.loadClass("com.pattern.gaoqi.HelloWorld");
		Class<?> c2 = loader.loadClass("com.pattern.gaoqi.HelloWorld");
		Class<?> c3 = loader2.loadClass("com.pattern.gaoqi.HelloWorld");

		Class<?> c4 = loader2.loadClass("java.lang.String");
		Class<?> c5 = loader2.loadClass("com.gaoqi.classLoad.DoubleParentProxy");
